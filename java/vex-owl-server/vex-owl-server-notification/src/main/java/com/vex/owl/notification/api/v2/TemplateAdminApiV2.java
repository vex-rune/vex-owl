package com.vex.owl.notification.api.v2;
...
/**
 * 模版管理 V2 接口
 * <p>模板管理相关业务接口，V2 版本，用于灰度发布</p>
 */
@RestController
@RequestMapping("/api/v2/notification/admin/template")
@RequiredArgsConstructor
public class TemplateAdminApiV2 {

    private final TemplateManager templateManager;

    /**
     * 通知-模板通用查询 V2
     * <p>分页+多条件组合查询，返回 V2 版本数据</p>
     *
