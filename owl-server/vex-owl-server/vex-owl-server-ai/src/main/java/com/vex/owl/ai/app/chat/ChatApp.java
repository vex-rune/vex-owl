...
public class ChatApp {
    ...
    public Flux<String> chat(String tenantId, String sessionId, String prompt) {
        ChatSessionEntity session = chatManager.getSession(tenantId, "CHAT");

        String resolvedSessionId = sessionId != null ? sessionId : session.getId();
        ...
        // MemoryAdvisor 已由 DefaultAiManager 自动加载
